...
declare const utils: {
    ...
    each(array: any[], callback: any, thisArg?: null): void;
    eachKey(object: any, callback: any, thisArg?: null): void;
    ...
    getRoleHierarchyOf(grants: any, roleName: string, rootRole?: string | undefined): string[];
