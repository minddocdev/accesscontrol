...
function getInspectedGrants(grantsObject) {
    ...
    if (type(grantsObject) === 'object') {
        ...
        throw new core_1.AccessControlError('Invalid grants object. Expected an array or object.');
    }
    return grants;
}
...
function filter(object, attributes) {
...
function filterAll(arrOrObj, attributes) {
